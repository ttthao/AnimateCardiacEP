...
# Time constants
FRAME_NUM = 198                                      # Time between frames
TIME = 197                                            # Times in colormap
START = 197
KEYFRAMES = 263

# Find the right place to run the job
with open('/data/tthao/blender/EP/logs/log3.txt', 'w') as f:
    ...
    bpy.context.user_preferences.system.compute_device = 'CUDA_3'
