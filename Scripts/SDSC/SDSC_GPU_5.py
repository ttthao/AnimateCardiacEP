...
# Time constants
FRAME_NUM = 330                                      # Time between frames
TIME = 329                                            # Times in colormap
START = 329
KEYFRAMES = 395

# Find the right place to run the job
with open('/data/tthao/blender/EP/logs/log5.txt', 'w') as f:
    ...
    bpy.context.user_preferences.system.compute_device = 'CUDA_5'
