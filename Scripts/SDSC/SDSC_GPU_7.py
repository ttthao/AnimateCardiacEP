...
# Time constants
FRAME_NUM = 461                                      # Time between frames
TIME = 460                                            # Times in colormap
START = 460
KEYFRAMES = 526

# Find the right place to run the job
with open('/data/tthao/blender/EP/logs/log7.txt', 'w') as f:
    ...
    bpy.context.user_preferences.system.compute_device = 'CUDA_7'
